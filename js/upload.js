...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  const close = $('uploadClose'); if(close) close.onclick = ()=> hide($('uploadModal'));
  const modal = $('uploadModal'); if(modal) modal.addEventListener('click', (e)=>{ if(e.target===modal) hide($('uploadModal')); });
